...
from giteaapi.logging.configuration.api_logging_configuration import (
...
class Configuration(HttpClientConfiguration):
    ...
    def __init__(self, http_client_instance=None,
                 ...
                 environment=Environment.PRODUCTION, access_token_credentials=None,
    ...
    environments = {
        Environment.PRODUCTION: {
            Server.SERVER1: "https://gitea.com/api/v1",
            Server.SERVER2: "http://gitea.com/api/v1",
        },
    }
